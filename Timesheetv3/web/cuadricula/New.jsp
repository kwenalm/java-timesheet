...
<f:view>
    <html>
        ...
        <h1>New Cuadricula</h1>
        <h:form>
            <h:inputHidden id="validateCreateField" validator="#{cuadricula.validateCreate}" value="value"/>
            ...
            <br />
            <h:commandLink action="#{cuadricula.create}" value="Create"/>
            <br />
            <br />
