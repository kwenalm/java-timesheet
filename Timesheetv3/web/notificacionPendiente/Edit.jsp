...
<f:view>
    <html>
        <head>
            ...
            <title>Editing NotificacionPendiente</title>
        ...
        <h1>Editing NotificacionPendiente</h1>
        <h:form>
            ...
            <br />
            <h:commandLink action="#{notificacionPendiente.edit}" value="Save">
            ...
            <br />
            <br />
            <h:commandLink action="#{notificacionPendiente.detailSetup}" value="Show" immediate="true">
                <f:param name="jsfcrud.currentNotificacionPendiente" value="#{jsfcrud_class['vista.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][notificacionPendiente.notificacionPendiente][notificacionPendiente.converter].jsfcrud_invoke}"/>
            </h:commandLink>
            <br />
