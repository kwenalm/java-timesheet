...
<f:view>
    <html>
        <head>
            ...
            <title>New Notificaciones</title>
        ...
        <h1>New Notificaciones</h1>
        <h:form>
            <h:inputHidden id="validateCreateField" validator="#{notificaciones.validateCreate}" value="value"/>
            <h:panelGrid columns="2">
                <h:outputText value="IdNotificaciones:"/>
                <h:inputText id="idNotificaciones" value="#{notificaciones.notificaciones.idNotificaciones}" title="IdNotificaciones" required="true" requiredMessage="The idNotificaciones field is required." />
            ...
            <br />
            <h:commandLink action="#{notificaciones.create}" value="Create"/>
            <br />
            <br />
